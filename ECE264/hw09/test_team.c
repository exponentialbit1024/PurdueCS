...
//	struct Person people[] = {
//		{ .name = "Alarand Osocenticher", .favorite = &people[0]},
//	};
...
int main(int argc, char *argv[]){
	...
	struct Team cteam0 = copy_team(&team0);
	fprint_team(&cteam0, stdout);
	...
	struct Team cteam2 = copy_team(&team2);
	fprint_team(&cteam2, stdout);
